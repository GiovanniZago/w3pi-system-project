...
with h5py.File("l1Nano_SingleNeutrino_PU200_hwreco_fulldata.hdf5", "w") as f_out:
    for ev_idx, ev_raw_data in tqdm(enumerate(pd.read_csv("l1Nano_SingleNeutrino_PU200_hwreco_fulldata.csv", header=None, names=["data"], chunksize=4))):
